...
namespace Backend.DAL.Databases.Migrations
{
    ...
    [Migration("20240603100607_AddComboService")]
    partial class AddComboService
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.BO.Commons.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a8d24f09-03f2-42cd-b727-03b96ab7b600"),
                        ...
                        new
                        {
                            Id = new Guid("1d5e28bd-19fb-4eb5-8ad2-d4be68a6d5a2"),
                        ...
                        new
                        {
                            Id = new Guid("61e0314c-8eff-48ee-ac71-cd10e36f1590"),
                        ...
                        new
                        {
                            Id = new Guid("37030f57-4de5-4835-951b-955d6ed227a6"),
                        ...
                        new
                        {
                            Id = new Guid("a6df0c23-d12a-4718-9e55-d1d268d4a7ee"),
                        ...
                        new
                        {
                            Id = new Guid("b66076ca-15b4-44ae-b955-79638349828c"),
                        ...
                        new
                        {
                            Id = new Guid("c4118b70-cc3b-43b5-91af-99d7c073e782"),
                        ...
                        new
                        {
                            Id = new Guid("a4f3b037-dbcf-4539-8209-a2efd141d64d"),
                        ...
                        new
                        {
                            Id = new Guid("c85897d4-4e1d-4a88-b44e-fb0236ace39a"),
            ...
            modelBuilder.Entity("Backend.BO.Entities.Combo", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ComboName = "Gói ưu đãi Răng sạch miệng thơm",
                            Description = "Gồm Khám răng tổng quát và Vệ sinh răng"
                        },
                        new
                        {
                            Id = 2,
                            ComboName = "Gói ưu đãi nhổ răng",
                            Description = "Gồm Khám răng tổng quát và nhổ răng"
                        },
                        new
                        {
                            Id = 3,
                            ComboName = "Gói giành cho người lớn tuổi",
                            Description = "Gồm Khám răng tổng quát và Trám răng"
                        },
                        new
                        {
                            Id = 4,
                            ComboName = "Gói Răng bạn thưa hãy lựa gói này",
                            Description = "Gồm Khám răng tổng quát và Niềng răng"
                        });
                });
            ...
            modelBuilder.Entity("Backend.BO.Entities.Service", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClinicId = 1,
                            Description = "Bệnh nhân sẽ được khám tổng quát để biết được tình trạng sức khỏe răng miệng",
                            Price = 50.0,
                        ...
                        new
                        {
                            Id = 2,
                            ClinicId = 2,
                            Description = "Đánh bóng, lấy cao răng",
                            Price = 80.0,
                            ServiceName = "Vệ sinh răng"
                        },
                        new
                        {
                            Id = 3,
                        ...
                        new
                        {
                            Id = 4,
                            ClinicId = 1,
                            Description = "Nếu răng thưa bị thưa hay mọc lệch, hãy niềng răng để có một hàm răng đẹp hơn",
                            Price = 100.0,
                        ...
                        new
                        {
                            Id = 5,
                            ClinicId = 2,
                            Description = "Nhổ răng sữa, răng khôn",
                            Price = 120.0,
