...
namespace Backend.DAL.Databases.Migrations
{
    ...
    [Migration("20240611031138_AddClinicFeedbackTable")]
    partial class AddClinicFeedbackTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.BO.Commons.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1020d42b-c2b6-4615-96f1-3e4f36420b8f"),
                        ...
                        new
                        {
                            Id = new Guid("5ddc8bd2-de75-4062-96c4-808cd90ee264"),
                        ...
                        new
                        {
                            Id = new Guid("3dda6601-fff6-48ec-9133-03ba07133400"),
                        ...
                        new
                        {
                            Id = new Guid("205034b8-3fe2-4047-9dac-90c06b73757f"),
                        ...
                        new
                        {
                            Id = new Guid("18728392-fce6-491c-86e6-6d662212a3d9"),
                        ...
                        new
                        {
                            Id = new Guid("233ab089-425f-4cfe-9f7f-fec750083c47"),
                        ...
                        new
                        {
                            Id = new Guid("54030f14-f364-4113-b2b0-85db28fa46a5"),
                        ...
                        new
                        {
                            Id = new Guid("ece94aff-e8f1-4c58-8869-270d2bbb22f7"),
                        ...
                        new
                        {
                            Id = new Guid("ba970efc-ae6b-411f-9928-1fc9b3c92c90"),
            ...
            modelBuilder.Entity("Backend.BO.Entities.ClinicFeedback", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FeedbackDate = new DateTime(2024, 6, 11, 10, 11, 36, 917, DateTimeKind.Local).AddTicks(7557),
